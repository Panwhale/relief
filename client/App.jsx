...
class App extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      defaultZip: '90013', //downtown LA
      defaultRating: '4', // needs to be between 1 and 4
      defaultCause: '1', // still need to figure out 
    }
  ...
  render() {
    return (
      <div>
        <Filters rows={this.state.rows} defaultZip={this.state.defaultZip} defaultRating={this.state.defaultRating} defaultCause={this.state.defaultCause}/>
        Filters
